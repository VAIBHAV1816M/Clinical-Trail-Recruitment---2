            ...
            {result ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                <div style={{
                  ...
                  <h3 style={{ fontSize: '1.3rem', fontWeight: 700, margin: '0 0 0.5rem', color: result.eligible ? '#34d399' : '#f87171' }}>
                    {result.eligible ? 'Eligible for Study' : 'Not Currently Eligible'}
                  </h3>
                  <div style={{ fontSize: '0.95rem', color: '#e2e8f0', marginBottom: '0.75rem' }}>
                    {result.message}
                  </div>
                  <div style={{ display: 'inline-block', background: 'rgba(0,0,0,0.3)', padding: '0.35rem 0.85rem', borderRadius: '20px', fontSize: '0.85rem', color: '#cbd5e1' }}>
                    Match Score: <strong style={{ color: '#ffffff' }}>{result.match_percentage}%</strong> (Verdict: {result.verdict})
                  </div>
                </div>
              ...
              <form onSubmit={handleEvaluate} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                <p style={{ margin: 0, fontSize: '0.875rem', color: '#94a3b8', lineHeight: 1.4 }}>
                  This form is dynamically generated based on <strong>{trial.trial_name}</strong>'s specific inclusion/exclusion criteria. Attributes already in your clinical profile are pre-filled below.
                </p>
                        ...
                        >
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
                            <label style={{ fontSize: '0.9rem', fontWeight: 600, color: '#f8fafc' }}>
                              {formatFieldName(crit.field)} {isHard && <span style={{ color: '#ef4444' }}>*</span>}
                            </label>
                            <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                              ...
                              <span style={{
                                background: isHard ? 'rgba(239, 68, 68, 0.15)' : 'rgba(234, 179, 8, 0.15)',
                                color: isHard ? '#f87171' : '#facc15',
                                fontSize: '0.7rem',
                                fontWeight: 700,
                                padding: '0.2rem 0.5rem',
                                borderRadius: '4px'
                          ...
                          {crit.data_type === 'BOOLEAN' ? (
                            ...
                            <div>
                              ...
                              {crit.numeric_min !== null && crit.numeric_max !== null && (
                                <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginTop: 4 }}>
                                  Acceptable range: {crit.numeric_min} to {crit.numeric_max}
                                </div>
                              )}
                            </div>
                          ) : (
                            <div>
                              ...
                              {crit.categorical_ideal && (
                                <div style={{ fontSize: '0.75rem', color: '#94a3b8', marginTop: 4 }}>
                                  Required/Preferred value: <strong>{crit.categorical_ideal}</strong>
                                </div>
                              )}
                            </div>
                          )}
