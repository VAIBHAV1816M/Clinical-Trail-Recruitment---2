...
export function InvitationsPage({ setActiveTab }) {
  ...
  const handleAccept = (trialId) => {
    ...
    showToast('Invitation Accepted', 'You have accepted the study invitation. The coordinator will reach out shortly.', 'success');
  };

  const handleDecline = (trialId) => {
    declineInvite(trialId, patient.patient_id, 'Declined by patient');
    showToast('Invitation Declined', 'Study invitation declined.', 'info');
  };
